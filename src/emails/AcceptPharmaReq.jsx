...
export default function AcceptPharmaReq({ name, pharmaName }) {
  return (
    <Html>
      <Tailwind>
        <div className="bg-gray-100 p-8 rounded-lg">
          ...
          <Text className="text-gray-700 mt-4 font-sans">
            ...
            registration for <b>{pharmaName}</b> has been successfully approved.
            We are excited to have you join our platform and look forward to
            supporting your pharmacy's growth and success.
          </Text>
          <Text className="text-gray-700 mt-4 font-sans">
          ...
          <Text className="text-gray-700 mt-4 font-sans italic font-bold">
            Note: You can use the Pharmacy's email for signing up.
          </Text>
