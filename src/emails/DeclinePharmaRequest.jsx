...
export default function DeclinePharmaRequest({ name, pharmName }) {
  return (
    <Html>
      <Tailwind>
        <div className="bg-gray-100 p-8 rounded-lg">
          ...
          <Text className="text-gray-700 mt-4 font-sans">
            Thank you for your interest in registering <b>{pharmName}</b> with
          ...
          <Text className="text-gray-700 mt-4 font-sans">
            ...
            this outcome is not a reflection of the quality of your pharmacy but
